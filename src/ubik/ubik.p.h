...
extern afs_int32 ubik_epochTime[MAX_UBIK_DBASES];	/* time when this site started */
...
extern struct ubik_version ubik_dbVersion[MAX_UBIK_DBASES];	/* sync site's dbase version */
...
extern int urecovery_CheckTid(struct ubik_tid *atid, afs_int32 index);
...
extern afs_int32 ubik_CallIter(int (*aproc) (struct rx_connection*, ...),
                               struct ubik_client *aclient,
...
extern afs_int32 ubik_Call_New(int (*aproc) (struct rx_connection*, ...),
                               struct ubik_client *aclient,
