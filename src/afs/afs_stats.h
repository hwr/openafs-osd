...
#define AFS_CM_CALL_STATS \
    ...
    AFS_CS(SRXAFSCB_GetDCacheEntry) /* afs_callback.c */ \
    AFS_CS(CheckRxosdServer)   /* afs_server.c */
...
#define AFS_STATS_CM_RPCIDX_GETDCACHE   	30

#define AFS_STATS_NUM_FS_RPC_OPS		31
