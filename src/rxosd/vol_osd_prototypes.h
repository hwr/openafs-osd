...
extern afs_int32 dump_osd_file(afs_int32 (*ioroutine)(void *rock, char *buf, afs_uint32 lng,
			afs_uint64 offset), 
			void *rock, Volume *vol, struct VnodeDiskObject *vd,
                        afs_uint32 vN, afs_uint64 offset, afs_int64 length);
extern afs_int32 restore_osd_file(afs_int32 (*ioroutine)(void *rock, char *buf, afs_uint32 lng,
			afs_uint64 offset), 
			void *rock, Volume *vol, struct VnodeDiskObject *vd,
                        afs_uint32 vN, afs_uint64 offset, afs_int64 length);
...
extern afs_int32 get_arch_osds(Vnode *vn, afs_int64 *length, afs_uint32 *osds);
extern afs_int32 osd_split_objects(Volume *vol, Volume *newvol, 
				struct VnodeDiskObject *vd, afs_uint32 vN);
extern afs_int32 list_osds(Vnode *vn, afs_uint32 *out); 
extern afs_int32 actual_length(Volume *vol, struct VnodeDiskObject *vd, afs_uint32 vN, 
                               afs_sfsize_t *size);
...
afs_int32 isOsdFile(
        afs_int32 osdPolicy, afs_uint32 vid,
        struct VnodeDiskObject *vd, afs_uint32 vN);

extern afs_int32 remove_osd_online_file(
        Vnode *vn, afs_uint32 version);

extern afs_int32 createFileWithPolicy(
        AFSFid *Fid,
        afs_uint64 size,
...
extern afs_int32 update_osd_metadata(
        Volume *vol,
        Vnode *vn, struct ometa *old, struct ometa *new);
